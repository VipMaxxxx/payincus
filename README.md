...
PayIncus 是基于开源项目 [qwer-xyz/incudal](https://github.com/qwer-xyz/incudal) 进行二次开发的 Incus 面板，面向 NAT VPS、LXC / KVM 实例、套餐销售、账务计费、用户后台、管理员后台、宿主机 Agent、第三方扩展和主题系统管理场景。
