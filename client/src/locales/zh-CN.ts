export default {
    ...
    flashSales: {
        firstTermOnly: '仅首期秒杀价，续费按原价。',
        title: '秒杀',
        description: '限时活动套餐，库存和交付以实时资源校验为准。',
        loadFailed: '加载秒杀活动失败：{error}',
        reservationsLoadFailed: '加载抢购记录失败：{error}',
        empty: '暂无秒杀活动',
        emptyHint: '有新活动时会在这里展示。',
        buyNow: '立即抢购',
        perUserLimit: '每人限购 {count} 台',
        planResources: '{cpu}% 核 {memory} {disk}',
        stock: '库存 {remaining} / {total}',
        soldPercent: '已售 {percent}%',
        myReservations: '我的抢购记录',
        reservationsDescription: '显示最近 20 条秒杀购买和交付结果。',
        refreshReservations: '刷新记录',
        noReservations: '暂无抢购记录',
        status: {
            notStarted: '未开始', paused: '已暂停', ended: '已结束', soldOut: '已抢完',
            planUnavailable: '方案不可用', active: '进行中', upcoming: '即将开始',
        },
        columns: { campaign: '活动', package: '套餐', amount: '金额', status: '状态', time: '时间' },
    },
    hostPublicIpv4: {
    ...
    userLifecycle: {
        title: '用户生命周期', description: '围绕注册、首购、续费、到期、流失风险和召回做运营动作。',
        syncEvents: '同步事件', refreshSegments: '刷新分群', userList: '用户列表',
        instanceCount: '{count} 个实例', expiringCount: '{count} 个即将到期', noMatchingUsers: '暂无匹配用户',
        pagination: '共 {total} 条，第 {page}/{totalPages} 页', tags: '标签', optionalNote: '备注，可选', addTag: '添加标签',
        used: '已使用', unused: '未使用', lifecycle: '生命周期', operations: '运营动作', selectUserHint: '选择一个用户查看商业摘要和运营动作。',
        metrics: { totalUsers: '用户总数', activeUsers: '活跃用户', expiringInstances: '即将到期实例', selectedUsers: '已选用户' },
        filters: {
            title: '筛选', searchPlaceholder: '搜索用户名、邮箱、用户 ID', allTags: '全部标签', allSegments: '全部分群',
            allActivityStates: '全部活跃状态', active: '活跃', inactive: '不活跃', minRecharge: '最低累计充值',
            maxRecharge: '最高累计充值', minInstances: '最低实例数', maxInstances: '最高实例数',
        },
        summary: {
            title: '用户摘要', user: '用户', email: '邮箱', totalRecharge: '累计充值', totalConsume: '累计消费', instances: '实例',
            instanceValue: '{total} / 运行 {running}', earliestExpiry: '最早到期', tickets: '工单', ticketValue: '{total} / 未结 {open}', lastLogin: '最后登录',
        },
        redeemCode: {
            title: '定向资源兑换码', hostId: '节点 ID', memory: '内存', disk: '磁盘', traffic: '流量',
            value: '数值（{unit}）', validDays: '有效天数', issue: '发放',
        },
        reminder: {
            title: '批量提醒', defaultTitle: '续费提醒', defaultContent: '您的服务即将到期，请及时查看实例并完成续费。',
            titlePlaceholder: '提醒标题', contentPlaceholder: '提醒内容', confirm: '确认向已选 {count} 个用户发送站内提醒', send: '发送提醒',
        },
        messages: {
            overviewLoadFailed: '加载生命周期总览失败：{error}', usersLoadFailed: '加载生命周期用户失败：{error}', segmentsRefreshed: '分群已刷新',
            segmentsRefreshFailed: '刷新分群失败：{error}', eventsSynced: '生命周期事件已同步：{count} 条', eventsSyncFailed: '同步事件失败：{error}',
            summaryLoadFailed: '加载用户摘要失败：{error}', tagAdded: '标签已添加', tagAddFailed: '添加标签失败：{error}', tagRemoved: '标签已移除',
            tagRemoveFailed: '移除标签失败：{error}', invalidRedeemCode: '请填写有效的节点 ID、数值和有效期', redeemCodeIssued: '已发放兑换码：{code}',
            redeemCodeIssueFailed: '发放兑换码失败：{error}', selectAndConfirm: '请选择用户并勾选确认', remindersSent: '已发送 {count} 条提醒',
            reminderSendFailed: '发送提醒失败：{error}',
        },
    },
    telegramConfig: {
    ...
    extensions: {
        ...
        themeSubmissions: {
            entry: '投稿主题',
            title: '提交主题审核',
            description: '提交主题的 HTTPS Release、manifest、主题包地址、SHA256、兼容范围、token 和布局槽说明。',
            freeReviewHint: '主题投稿当前仅支持免费上架；提交后进入待审核状态，由管理员扫描、审核并发布市场目录。',
            themeId: '主题 ID',
            version: '版本',
            name: '主题名称',
            contactEmail: '联系邮箱',
            ...
            compatibility: '兼容 JSON',
            tokens: 'Token 列表',
            layoutSlots: '布局槽列表',
            listPlaceholder: '每行一项，或使用英文逗号分隔',
            notes: '说明',
            notesPlaceholder: '主题说明、回滚说明、外部资源依赖等',
            submit: '提交审核',
            submitting: '提交中...',
            submitSuccess: '主题投稿已提交审核',
            submitFailed: '提交主题审核失败',
            mine: '我的主题投稿',
            mineHint: '审核通过后会由平台发布到主题市场目录。',
            refresh: '刷新',
            loading: '加载中...',
            empty: '暂无主题投稿。',
            loadFailed: '加载主题投稿失败',
            ...
            submittedAt: '提交',
            reviewedAt: '审核',
            status: { pending: '待审核', listed: '已通过', rejected: '已拒绝', delisted: '已下架' },
            scan: { pending: '未扫描', passed: '扫描通过', warning: '有警告', failed: '扫描失败' },
        },
        initCommands: {
            title: '自定义初始化命令',
