export default {
    pluginCenter: {
        status: {
            enabled: 'Enabled',
            pendingReenable: 'Pending re-enable',
            failed: 'Failed',
            disabled: 'Disabled',
        },
        actions: {
    ...
    flashSales: {
        firstTermOnly: 'Flash sale price applies to the first term only; renewals return to the original price.',
        title: 'Flash Sales', description: 'Limited-time plans. Inventory and delivery depend on real-time resource validation.',
        loadFailed: 'Failed to load flash sales: {error}', reservationsLoadFailed: 'Failed to load purchase records: {error}', empty: 'No flash sales', emptyHint: 'New campaigns will appear here.',
        buyNow: 'Buy now', perUserLimit: 'Limit {count} per user', planResources: '{cpu}% CPU {memory} {disk}', stock: 'Stock {remaining} / {total}', soldPercent: '{percent}% sold',
        myReservations: 'My purchases', reservationsDescription: 'Shows the latest 20 flash-sale purchases and delivery results.', refreshReservations: 'Refresh records', noReservations: 'No purchase records',
        status: { notStarted: 'Not started', paused: 'Paused', ended: 'Ended', soldOut: 'Sold out', planUnavailable: 'Plan unavailable', active: 'Active', upcoming: 'Coming soon' },
        columns: { campaign: 'Campaign', package: 'Package', amount: 'Amount', status: 'Status', time: 'Time' },
    },
    hostPublicIpv4: {
    ...
    userLifecycle: {
        title: 'User Lifecycle', description: 'Run lifecycle operations around registration, first purchase, renewal, expiry, churn risk, and re-engagement.', syncEvents: 'Sync events', refreshSegments: 'Refresh segments',
        userList: 'User list', instanceCount: '{count} instances', expiringCount: '{count} expiring soon', noMatchingUsers: 'No matching users', pagination: '{total} total, page {page}/{totalPages}',
        tags: 'Tags', optionalNote: 'Optional note', addTag: 'Add tag', used: 'Used', unused: 'Unused', lifecycle: 'Lifecycle', operations: 'Operations', selectUserHint: 'Select a user to view the commercial summary and operations.',
        metrics: { totalUsers: 'Total users', activeUsers: 'Active users', expiringInstances: 'Instances expiring soon', selectedUsers: 'Selected users' },
        filters: { title: 'Filters', searchPlaceholder: 'Search username, email, or user ID', allTags: 'All tags', allSegments: 'All segments', allActivityStates: 'All activity states', active: 'Active', inactive: 'Inactive', minRecharge: 'Minimum total recharge', maxRecharge: 'Maximum total recharge', minInstances: 'Minimum instances', maxInstances: 'Maximum instances' },
        summary: { title: 'User summary', user: 'User', email: 'Email', totalRecharge: 'Total recharge', totalConsume: 'Total spend', instances: 'Instances', instanceValue: '{total} / {running} running', earliestExpiry: 'Earliest expiry', tickets: 'Tickets', ticketValue: '{total} / {open} open', lastLogin: 'Last login' },
        redeemCode: { title: 'Targeted resource redeem code', hostId: 'Host ID', memory: 'Memory', disk: 'Disk', traffic: 'Traffic', value: 'Value ({unit})', validDays: 'Valid days', issue: 'Issue' },
        reminder: { title: 'Bulk reminder', defaultTitle: 'Renewal reminder', defaultContent: 'Your service is about to expire. Please review your instances and renew in time.', titlePlaceholder: 'Reminder title', contentPlaceholder: 'Reminder content', confirm: 'Confirm sending an inbox reminder to {count} selected users', send: 'Send reminder' },
        messages: { overviewLoadFailed: 'Failed to load lifecycle overview: {error}', usersLoadFailed: 'Failed to load lifecycle users: {error}', segmentsRefreshed: 'Segments refreshed', segmentsRefreshFailed: 'Failed to refresh segments: {error}', eventsSynced: 'Synced {count} lifecycle events', eventsSyncFailed: 'Failed to sync events: {error}', summaryLoadFailed: 'Failed to load user summary: {error}', tagAdded: 'Tag added', tagAddFailed: 'Failed to add tag: {error}', tagRemoved: 'Tag removed', tagRemoveFailed: 'Failed to remove tag: {error}', invalidRedeemCode: 'Enter a valid host ID, value, and validity period', redeemCodeIssued: 'Redeem code issued: {code}', redeemCodeIssueFailed: 'Failed to issue redeem code: {error}', selectAndConfirm: 'Select users and check the confirmation box', remindersSent: 'Sent {count} reminders', reminderSendFailed: 'Failed to send reminders: {error}' },
    },
    telegramConfig: {
    ...
    extensions: {
        ...
        themeSubmissions: {
            entry: 'Submit Theme',
            title: 'Submit Theme for Review',
            description: 'Provide the theme HTTPS release, manifest and package URLs, SHA256, compatibility, tokens, and layout slots.',
            freeReviewHint: 'Theme submissions currently support free listings only. Submissions enter review and must be scanned, approved, and published by an administrator.',
            themeId: 'Theme ID',
            version: 'Version',
            name: 'Theme Name',
            contactEmail: 'Contact Email',
            ...
            tokens: 'Token List',
            layoutSlots: 'Layout Slot List',
            listPlaceholder: 'One item per line, or separate items with commas',
            notes: 'Notes',
            notesPlaceholder: 'Theme details, rollback notes, external asset dependencies, etc.',
            submit: 'Submit for Review',
            submitting: 'Submitting...',
            submitSuccess: 'Theme submitted for review',
            submitFailed: 'Failed to submit theme for review',
            mine: 'My Theme Submissions',
            mineHint: 'Approved themes are published to the theme market by the platform.',
            refresh: 'Refresh',
            loading: 'Loading...',
            empty: 'No theme submissions yet.',
            loadFailed: 'Failed to load theme submissions',
            scanLabel: 'Scan',
            submittedAt: 'Submitted',
            reviewedAt: 'Reviewed',
            status: { pending: 'Pending', listed: 'Approved', rejected: 'Rejected', delisted: 'Delisted' },
            scan: { pending: 'Not scanned', passed: 'Passed', warning: 'Warnings', failed: 'Failed' },
        },
        initCommands: {
